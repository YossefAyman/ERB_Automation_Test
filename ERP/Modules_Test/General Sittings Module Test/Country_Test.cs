...
namespace ERP_Automation_Testing
{
    ...
    class M2_General_Sittings_N1_Country_Test
    {
        ...
        public void T1_AddCountry()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.CountryName) == "Exist", "T1_AddCountry Failed");
        }
        ...
        public void T2_EditCountry()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.CountryName + "_edit") == "Exist", "T2_EditCountry Failed");
        }
        ...
        public void T3_DeleteCountry()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.CountryName + "_edit") == "NotExist", "T3_DeleteCountry Failed");
        }
