...
namespace ERP_Automation_Testing
{
    class M2_General_Sittings_N4_District_Test
    {
        ...
        public void T1_AddDistrict()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.DistrictName) == "Exist", "T1_AddDistrict Failed");
        }
        ...
        public void T2_EditDistrict()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.DistrictName + "_edit") == "Exist", "T2_EditDistrict Failed");
        }
        ...
        public void T3_DeleteDistrict()
        {
            ...
            Assert.IsTrue(Customer_Page.Search(Data.Place.DistrictName + "_edit") == "NotExist", "T3_DeleteDistrict Failed");
        }
