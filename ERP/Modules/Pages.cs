...
namespace ERP_Automation_Testing
{
    ...
    class Pages
    {
        ...
        {
            PROFILES = 4, GENERAL_SITTINGS = 6, FINANCIALS = 8, INVENTORIES = 9, SALES = 9, PURCHASES = 11, ESTATE = 14, assets = 3 
        }
        ...
        {
            CURRENCY = 4, BANK = 7, BANK_ACCOUNT = 8, TAX = 9, COST_CENTER = 10, Receiptvoucher = 1, DailyRestrictions=12
        ...
        {
            BRAND = 1, STORE = 2, INVENTORY_CATEGORY = 3, INVENTORY_PERMISSION = 4, ADDING_PERMISSION = 8, ITEM_TYPE = 12, ITEM = 13, Itemstatus = 12,
        }
        ...
        {
            SALES_BILL = 1, SALES_BILL_RETURNS = 2
        }
        ...
        static By Assets_page = By.CssSelector("body > div.wrapper > aside > div > ul > li:nth-child(3) > ul > li > a > span");
